...
<section class="bg-gray-100 min-h-screen py-8">
  <div class="container mx-auto max-w-4xl">
    <div class="bg-white rounded-t-lg shadow p-6 mb-4 border-b-4 border-orange-300 flex justify-between items-center">
      ...
      <button
        class="bg-orange-300 hover:bg-orange-400 text-white px-5 py-3 rounded-lg font-semibold shadow transition"
        onclick="
          if (!${isLogined}) {
            alert('로그인 후 이용해주세요.');
          } else {
      ...
      <div class="flex-1 min-w-0">
		...
		<div class="bg-white rounded-lg shadow p-4 mb-4">
		  <div class="font-bold text-lg mb-3 flex items-center">
		    ...
		    <span>근무 리뷰 인기글</span>
		    <a href="/usr/article/list?boardId=4" class="ml-auto text-sm text-gray-500 hover:text-orange-400">더보기</a>
		  </div>
		...
		<div class="bg-white rounded-lg shadow p-4 mb-4">
		  <div class="font-bold text-lg mb-3 flex items-center">
		    ...
		    <span>면접 리뷰 인기글</span>
		    <a href="/usr/article/list?boardId=5" class="ml-auto text-sm text-gray-500 hover:text-orange-400">더보기</a>
		  </div>
		...
		<div class="bg-white rounded-lg shadow p-4 mb-4">
		  <div class="font-bold text-lg mb-3 flex items-center">
		    ...
		    <a href="/usr/article/list?boardId=6" class="ml-auto text-sm text-gray-500 hover:text-orange-400">더보기</a>
		  </div>
		...
		<c:if test="${board.id == 근무 리뷰 or board.id == 5 or board.id == 6 or board.id == 7 or board.id == 8}">
          <c:forEach items="${articles}" var="article">
            <div class="p-5 border-2">
              <div class="flex border-4 justify-items-start">
                <a href="detail?id=${article.getId()}" class="text-lg pr-5 font-bold text-gray-800 group-hover:text-orange-500 transition flex items-center gap-2">
